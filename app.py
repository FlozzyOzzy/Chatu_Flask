...
# creating a route that corresponds to the web application function
...
def get_product_details():
    ...
    connection = pymysql.connect (user= 'root', password='', host= 'localhost', database= 'chatusokogarden')
    # define the cursor
    cursor = connection.cursor(pymysql.cursors.DictCursor)
